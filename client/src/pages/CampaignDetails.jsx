    ...
    <div>
      ...
      <div className="w-full flex md:flex-row flex-col mt-10 gap-[30px]">
        ...
        <div className="flex md:w-[150px] w-full flex-wrap justify-between gap-[50px]">
          {remainingDays[0] >= 0 && (
          <CountBox title ="Days left" value={remainingDays[0]} />
          )}
          {remainingDays[0] < 0 && (
          <CountBox title ="Days elapsed" value={Math.abs(remainingDays[0])} />
          )}
      ...
      <div className="mt-[60px] flex lg:flex-row flex-col gap-5">
        <div className="flex-[2] flex flex-col gap-[40px]">
          <div>
            <h4 className="font-epilogue font-bold text-[18px] text-white uppercase">Creator</h4>
          ...
          <div>
            <h4 className="font-epilogue font-bold text-[18px] text-white uppercase">Story</h4>
          ...
          <div>
            <h4 className="font-epilogue font-bold text-[18px] text-white uppercase">Donators</h4>
            <div className="mt-[20px] flex flex-col gap-4">
              ...
              <p className="font-epilogue font-normal text-[16px] text-[#808191] leading-[26px]">No donators yet. Be the first one!</p>}
            </div>
          </div>
        </div>
        {remainingDays[0] > 0 && (
